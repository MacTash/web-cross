...
class JWTScanner:
    ...
    def _check_alg_none(self, decoded: Dict, token: str) -> Optional[Dict]:
    ...
    def _check_weak_alg(self, decoded: Dict) -> Optional[Dict]:
    ...
    def _check_exp_claim(self, decoded: Dict) -> Optional[Dict]:
        ...
        if exp - current_time > 30 * 24 * 60 * 60:
            return {
                ...
                "evidence": f"Token expires in more than 30 days",
                "confidence": "LOW"
            }
    ...
    def _check_jku_jwk(self, decoded: Dict) -> Optional[Dict]:
